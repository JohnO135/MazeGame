...
public class Maze extends JFrame{
    ...
    public static int coinMap[][] = new int[columns][rows];
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if(p.x == endMazeX && p.y == endMazeY){
                    if(coinCounter == 0){
                        ...
                        JOptionPane.showMessageDialog(null, "You need to collect ALL the coins to win!", "Continue", JOptionPane.INFORMATION_MESSAGE);
                    }  
                }
                if(coinMap[p.x][p.y] == 3){
                    if(coinCounter > 0){
                        coinCounter--;
                        map[p.x][p.y] = 1;
                    }
